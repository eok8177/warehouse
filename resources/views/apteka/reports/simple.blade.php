...
@section('content')
<h1 class="page-header">@lang('apteka.report') з {{$from}} по {{$to}}
    {!! link_to_route('apteka.report.excel', 'Export to Excel', ['from' => $from, 'to' => $to, 'type' => 'short'], ['class' => 'btn btn-info pull-right']) !!}
</h1>
